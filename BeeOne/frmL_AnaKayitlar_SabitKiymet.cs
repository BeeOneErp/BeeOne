...
namespace BeeOne
{
    public partial class frmL_AnaKayitlar_SabitKiymet : Form
    {
        public frmL_AnaKayitlar_SabitKiymet()
        {
            InitializeComponent();
            DatagridviewSetting(dataGridViewSabitKiymet);
        }
        ...
        {
            dataGridViewSabitKiymet.RowHeadersVisible = false;
            ...
            dataGridViewSabitKiymet.DefaultCellStyle.ForeColor = Color.White;
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            if (Application.OpenForms["frmAnaKayitlar_Stok"] == null)
            {
                ...
                form.kartturu = "(4) Sabit Kıymet";
                form.Show();
            }
            else
                Application.OpenForms["frmAnaKayitlar_Stok"].Activate();

            //if (Application.OpenForms["frmAnaKayitlar_SabitKiymet"] == null)
            //{
            //    frmAnaKayitlar_SabitKiymet form = new frmAnaKayitlar_SabitKiymet();
            //    form.Show();
            //}
            //else
            //    Application.OpenForms["frmAnaKayitlar_SabitKiymet"].Activate();
        }

        private void frmL_AnaKayitlar_SabitKiymet_Load(object sender, EventArgs e)
        {
            ...
            string demirbas_tablo = "ONE_" + frmno + "_ITEMS";
...
" ON IT.LOGICALREF = EKSI.STOCKREF  where IT.CARDTYPE=4";

            SqlDataAdapter da = new SqlDataAdapter(list_query.ToString(), baglan);
            DataSet ds = new DataSet();
            baglan.Open();
            da.Fill(ds, demirbas_tablo);
            dataGridViewSabitKiymet.DataSource = ds.Tables[demirbas_tablo];
            baglan.Close();
        }
    }
}
