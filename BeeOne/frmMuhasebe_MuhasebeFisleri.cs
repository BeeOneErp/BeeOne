...
namespace BeeOne
{
    public partial class frmMuhasebe_MuhasebeFisleri : Form
    {
        public frmMuhasebe_MuhasebeFisleri()
        {
            InitializeComponent();
        ...
        private void frmMuhasebe_MuhasebeFisleri_Load(object sender, EventArgs e)
        {
