...
namespace BeeOne
{
    public partial class frmL_StokIslemleri_SatinAlmaIrsaliye : Form
    {
        public frmL_StokIslemleri_SatinAlmaIrsaliye()
        {
            InitializeComponent();
            DatagridviewSetting(dataGridViewSatinAlmaIrsaliye);
        }
        ...
        {
            dataGridViewSatinAlmaIrsaliye.RowHeadersVisible = false;
            ...
            dataGridViewSatinAlmaIrsaliye.DefaultCellStyle.ForeColor = Color.White;
        ...
        {
            if (Application.OpenForms["frmStokIslemleri_SatinAlmaIrsaliye"] == null)
            {
                frmStokIslemleri_SatinAlmaIrsaliye form = new frmStokIslemleri_SatinAlmaIrsaliye();
                form.Show();
            }
            else
                Application.OpenForms["frmStokIslemleri_SatinAlmaIrsaliye"].Activate();
        }

        private void frmL_StokIslemleri_SatinAlmaIrsaliye_Load(object sender, EventArgs e)
        {
            ...
            string alis_irs_tablo = "ONE_" + frmno + "_STFICHE";
...
" ONE_" + frmno + "_CLCARD CL ON STF.CLIENTREF = CL.LOGICALREF left join ONE_" + frmno + "_SALESMAN SL ON STF.SALESMANREF = SL.LOGICALREF WHERE STF.TRCODE IN(1,6)";

            SqlDataAdapter da = new SqlDataAdapter(list_query.ToString(), baglan);
            DataSet ds = new DataSet();
            baglan.Open();
            da.Fill(ds, alis_irs_tablo);
            dataGridViewSatinAlmaIrsaliye.DataSource = ds.Tables[alis_irs_tablo];
            baglan.Close();
